...
class MobileTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblMobName.text = temp.mobName
        cell.lblMobBattery.text = String(temp.mobBattery)
        cell.lblMobPrice.text = String(temp.Price)
        cell.lblMobMeomery.text = String(temp.mobMeomery)
