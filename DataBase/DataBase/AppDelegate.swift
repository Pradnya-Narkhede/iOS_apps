...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func createDB(){
        ...
        if sqlite3_open(dbPath.path, &db) == SQLITE_OK
        {
            ...
            let query = "create table Calculate(op1 integer,operation varchar[20],op2 integer,result integer,)"
            //"create table Person(person_name varchar[20],person_age integer,person_gender varchar[10])"
            //"create table Employee(emp_name varchar[20],emp_id integer)"
